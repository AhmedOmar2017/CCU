...
#define LCD_RS 						0	//LCD PIN 4 
#define LCD_RW						1	//LCD PIN 5 connect to GND. 
#define LCD_E 						2	//LCD PIN 6
...
#define LCDClear()				LCDSendCmd(0x01); _delay_ms(5)
